...
- All5 slot work has stable keys and commits atomically in one terminal page attempt. A terminal attempt stores generation audit, all candidates, DDG and second-stage evidence, outcomes, candidate IDs, and timings.
