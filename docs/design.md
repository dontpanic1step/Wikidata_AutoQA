...
If at least one answer type has zero candidates after page allocation, finalization skips answer-type rebalancing and outputs every page-allocated candidate.
