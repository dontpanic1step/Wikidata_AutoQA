...
RETIRED_TEMPLATE_NOTES: dict[str, str] = {
    "marriage_spouse": (
        "Retired because broad spouse identity is not tied to one historically "
        "settled slice of relationship history."
    ),
    "company_industry": (
        "Retired because broad industry answers are often too underspecified for "
        "a single high-precision gold answer."
    ),
}
...
DATE_ANSWER_PILOT_TEMPLATE_CATALOG = [
    _template(
        ...
        "P577",
        "publication date",
        "On what month, day, and year was the benchmark {descriptor} released?",
        answer_format="date",
    ...
    _template(
        ...
        "P577",
        "publication date",
        "On what month, day, and year was the product {descriptor} released?",
        answer_format="date",
        temporal_mode="date_answer",
        date_answer_granularity="day",
        status="date_answer_pilot",
    ...
    _template(
        ...
        "P571",
        "inception",
        "On what month, day, and year did the terminal {descriptor} open?",
        answer_format="date",
        temporal_mode="date_answer",
        date_answer_granularity="day",
        status="date_answer_pilot",
...
BLUEPRINT_TEMPLATE_CATALOG = [
    ...
    _template("ordinal_spouse", "People", "Person", "who_was_ordinal_spouse", "Q5", "human", "P580", "P26", "spouse", "Who was the {ordinal} spouse of {descriptor}?", composition_style="ordinal_fact", temporal_mode="time_related_join", reasoning_recipe={"new_element_slot": "relation", "new_element_hop": 1, "required_reasoning_clues": ["spouse"]}, status="blueprint"),
    _template("biography_birth_place_recent_subject", "People", "Place", "where_person_born", "Q5", "human", "P569", "P19", "place of birth", "Where was {descriptor} born?", query_tags=["staged_seed_query", "seed_window_daily", "seed_timeout_sensitive"], status="blueprint"),
    _template("biography_native_language_recent_subject", "People", "Language", "what_native_language_person", "Q5", "human", "P569", "P103", "native language", "What is the native language of {descriptor}?", query_tags=["staged_seed_query", "seed_window_daily", "seed_timeout_sensitive"], status="blueprint"),
    ...
    _template("product_manufacturer", "Economy and Business", "Organization", "which_company_manufactured_product", "Q2424752", "product", "P577", "P176", "manufacturer", "Which company manufactured the product {descriptor}?", query_tags=["staged_seed_query", "seed_window_weekly", "seed_timeout_sensitive"], status="blueprint"),
    ...
    # Society and Culture
    _template("festival_host_city", "Society and Culture", "Place", "which_city_hosts_festival", "Q132241", "festival", "P585", "P131", "located in administrative territorial entity", "Which city hosted {descriptor}?", query_tags=["require_english_subject_label"], status="blueprint"),
    ...
    _template("event_venue", "Society and Culture", "Place", "where_event_held", "Q1656682", "event", "P585", "P276", "location", "Where was {descriptor} held?", query_tags=["require_english_subject_label"], status="blueprint"),
    ...
    _template("philosophy_book_author", "Philosophy and Religion", "Person", "who_wrote_philosophy_book", "Q571", "book", "P577", "P50", "author", "Who wrote the philosophy book {descriptor}?", required_topic_keywords=["philosophy", "philosophical", "ethics", "metaphysics", "epistemology", "logic"], status="blueprint"),
    # Language and Literature
    ...
    # Sports and Recreation
    _template("tournament_host_country", "Sports and Recreation", "Place", "which_country_hosted_tournament", "Q132241", "tournament", "P585", "P17", "country", "Which country hosted {descriptor}?", query_tags=["require_english_subject_label"], status="blueprint"),
    ...
    _template("competition_venue", "Sports and Recreation", "Place", "where_competition_held", "Q16510064", "sports competition", "P585", "P276", "location", "Where was {descriptor} held?", query_tags=["require_english_subject_label"], status="blueprint"),
    # Education
    ...
    _template("textbook_publisher", "Education", "Organization", "which_publisher_released_textbook", "Q571", "textbook", "P577", "P123", "publisher", "Which publisher released the textbook {descriptor}?", required_topic_keywords=["textbook", "education", "educational", "instructional", "curriculum", "course"], status="blueprint"),
    # Mathematics
    _template("math_textbook_author", "Mathematics", "Person", "who_wrote_math_textbook", "Q571", "book", "P577", "P50", "author", "Who wrote the mathematics book {descriptor}?", query_tags=["require_english_subject_label"], required_topic_keywords=["mathematics", "mathematical", "algebra", "geometry", "calculus", "statistics", "probability"], status="blueprint"),
    _template("math_software_developer", "Mathematics", "Organization", "which_company_developed_math_software", "Q7397", "software", "P577", "P178", "developer", "Which company developed the mathematics software {descriptor}?", query_tags=["staged_seed_query", "seed_window_weekly", "seed_timeout_sensitive"], status="blueprint"),
    _template("math_paper_journal", "Mathematics", "Organization", "which_journal_published_math_article", "Q13442814", "scholarly article", "P577", "P1433", "published in", "In which journal was the mathematics article {descriptor} published?", query_tags=["require_english_subject_label"], required_topic_keywords=["mathematics", "mathematical", "algebra", "geometry", "calculus", "statistics", "probability"], status="blueprint"),
    _template("dataset_creator_math", "Mathematics", "Person", "who_created_math_dataset", "Q1172284", "dataset", "P577", "P170", "creator", "Who created the dataset {descriptor}?", required_topic_keywords=["mathematics", "mathematical", "algebra", "geometry", "calculus", "statistics", "probability"], status="blueprint"),
    # Physical Sciences
    _template("chemistry_article_journal", "Physical Sciences", "Organization", "which_journal_published_chemistry_article", "Q13442814", "scholarly article", "P577", "P1433", "published in", "In which journal was the chemistry article {descriptor} published?", query_tags=["require_english_subject_label"], required_topic_keywords=["chemistry", "chemical"], status="blueprint"),
    _template("physics_book_author", "Physical Sciences", "Person", "who_wrote_physics_book", "Q571", "book", "P577", "P50", "author", "Who wrote the physics book {descriptor}?", query_tags=["require_english_subject_label"], required_topic_keywords=["physics", "physical"], status="blueprint"),
    ...
    _template("physical_science_dataset_creator", "Physical Sciences", "Person", "who_created_science_dataset", "Q1172284", "dataset", "P577", "P170", "creator", "Who created the physical science dataset {descriptor}?", required_topic_keywords=["physics", "physical", "chemistry", "chemical", "astronomy", "geology"], status="blueprint"),
    # Life Sciences
    ...
    _template("bioinformatics_software_developer", "Life Sciences", "Organization", "which_company_developed_bioinformatics_software", "Q7397", "software", "P577", "P178", "developer", "Which company developed the bioinformatics software {descriptor}?", query_tags=["staged_seed_query", "seed_window_weekly", "seed_timeout_sensitive"], status="blueprint"),
    _template("biology_article_journal", "Life Sciences", "Organization", "which_journal_published_biology_article", "Q13442814", "scholarly article", "P577", "P1433", "published in", "In which journal was the biology article {descriptor} published?", query_tags=["require_english_subject_label"], required_topic_keywords=["biology", "biological", "genetics", "genomics", "bioinformatics", "ecology"], status="blueprint"),
    ...
    # Computer Science and AI
    _template("ai_model_developer", "Computer Science and AI", "Organization", "which_company_developed_model", "Q7397", "software", "P577", "P178", "developer", "Which company developed the model {descriptor}?", query_tags=["staged_seed_query", "seed_window_weekly", "seed_timeout_sensitive"], status="blueprint"),
    ...
    _template("dataset_creator_ai", "Computer Science and AI", "Person", "who_created_ai_dataset", "Q1172284", "dataset", "P577", "P170", "creator", "Who created the dataset {descriptor}?", required_topic_keywords=["artificial intelligence", "machine learning", "deep learning", "language model", "computer vision", "natural language processing", "nlp"], status="blueprint"),
    _template("paper_conference_ai", "Computer Science and AI", "Organization", "which_conference_published_ai_paper", "Q13442814", "scholarly article", "P577", "P1433", "published in", "At which venue was the AI paper {descriptor} published?", query_tags=["require_english_subject_label"], required_topic_keywords=["artificial intelligence", "machine learning", "deep learning", "language model", "computer vision", "natural language processing", "nlp"], status="blueprint"),
    _template("benchmark_release_date", "Computer Science and AI", "Date", "when_benchmark_released", "Q1172284", "dataset", "P577", "P577", "publication date", "On what month, day, and year was the benchmark {descriptor} released?", answer_format="date", temporal_mode="date_answer", date_answer_granularity="day", status="blueprint"),
    # Engineering and Technology
    ...
    _template("product_release_date", "Engineering and Technology", "Date", "when_product_released", "Q2424752", "product", "P577", "P577", "publication date", "On what month, day, and year was the product {descriptor} released?", answer_format="date", temporal_mode="date_answer", date_answer_granularity="day", status="blueprint"),
    # Architecture and Transportation
    ...
    _template("terminal_opening_date", "Architecture and Transportation", "Date", "when_terminal_opened", "Q55488", "terminal", "P571", "P571", "inception", "On what month, day, and year did the terminal {descriptor} open?", answer_format="date", temporal_mode="date_answer", date_answer_granularity="day", status="blueprint"),
    ...
    _template("biography_place_of_death_recent_subject", "People", "Place", "where_person_died", "Q5", "human", "P569", "P20", "place of death", "Where did {descriptor} die?", query_tags=["staged_seed_query", "seed_window_daily", "seed_timeout_sensitive"], status="blueprint"),
    _template("biography_occupation_recent_subject", "People", "Other", "what_occupation_person", "Q5", "human", "P569", "P106", "occupation", "What is the occupation of {descriptor}?", query_tags=["staged_seed_query", "seed_window_daily", "seed_timeout_sensitive"], status="blueprint"),
    _template("biography_notable_work_recent_subject", "People", "Work", "what_notable_work_person", "Q5", "human", "P569", "P800", "notable work", "What is a notable work by {descriptor}?", query_tags=["staged_seed_query", "seed_window_daily", "seed_timeout_sensitive"], status="blueprint"),
    ...
    _template("new_nature_reserve_country", "Geography", "Place", "which_country_nature_reserve_located", "Q473972", "nature reserve", "P571", "P17", "country", "In which country is the nature reserve {descriptor} located?", query_tags=["require_english_subject_label"], status="blueprint"),
    ...
    _template("monastery_country", "Philosophy and Religion", "Place", "which_country_monastery_located", "Q44613", "monastery", "P571", "P17", "country", "In which country is the monastery {descriptor} located?", query_tags=["require_english_subject_label"], status="blueprint"),
    ...
    _template("textbook_author", "Education", "Person", "who_wrote_textbook", "Q571", "textbook", "P577", "P50", "author", "Who wrote the textbook {descriptor}?", required_topic_keywords=["textbook", "education", "educational", "instructional", "curriculum", "course"], status="blueprint"),
    ...
    _template("math_award_presenter", "Mathematics", "Organization", "which_body_presents_math_award", "Q618779", "award", "P571", "P1027", "conferred by", "Which organization confers the mathematics award {descriptor}?", query_tags=["require_english_subject_label"], required_topic_keywords=["mathematics", "mathematical", "algebra", "geometry", "calculus", "statistics", "probability"], status="blueprint"),
    ...
    _template("species_parent_taxon", "Life Sciences", "Other", "what_parent_taxon_species", "Q16521", "taxon", "P577", "P171", "parent taxon", "What is the parent taxon of {descriptor}?", query_tags=["staged_seed_query", "seed_window_weekly", "seed_timeout_sensitive"], status="blueprint"),
    _template("taxonomy_database_creator", "Life Sciences", "Person", "who_created_taxonomy_dataset", "Q1172284", "dataset", "P577", "P170", "creator", "Who created the taxonomy dataset {descriptor}?", required_topic_keywords=["taxonomy", "taxonomic", "species", "genus", "biodiversity", "biology", "biological"], status="blueprint"),
    _template("medical_school_country", "Medicine and Health", "Place", "which_country_medical_school_located", "Q3914", "medical school", "P571", "P17", "country", "In which country is the medical school {descriptor} located?", query_tags=["require_english_subject_label"], required_topic_keywords=["medical", "medicine", "health", "clinical"], status="blueprint"),
    ...
    _template("software_license", "Computer Science and AI", "Other", "what_license_software", "Q7397", "software", "P577", "P275", "copyright license", "What license does the software {descriptor} use?", query_tags=["staged_seed_query", "seed_window_weekly", "seed_timeout_sensitive"], status="blueprint"),
    ...
    _template("battery_manufacturer", "Engineering and Technology", "Organization", "which_company_made_battery", "Q11173", "battery", "P577", "P176", "manufacturer", "Which company manufactured the battery {descriptor}?", query_tags=["staged_seed_query", "seed_window_weekly", "seed_timeout_sensitive"], status="blueprint"),
    ...
    _template("footballer_goals_in_ordinal_tournament", "Sports and Recreation", "Number", "how_many_goals_footballer_in_ordinal_tournament", "Q937857", "association football player", "P585", "COMPOSED_ORDINAL_TOURNAMENT_GOALS", "goals scored in ordinal tournament", "How many goals did {player_label} score in the {ordinal} edition of {descriptor}?", answer_format="number", composition_style="ordinal_fact", temporal_mode="time_related_join", reasoning_recipe={"new_element_slot": "relation", "new_element_hop": 2, "required_reasoning_clues": ["goals", "edition"]}, status="blueprint"),
    ...
    _template("person_birth_date", "People", "Date", "when_person_born", "Q5", "human", "P569", "P569", "date of birth", "On what month, day, and year was {descriptor} born?", answer_format="date", temporal_mode="date_answer", date_answer_granularity="day", query_tags=["staged_seed_query", "seed_window_daily", "seed_timeout_sensitive"], status="blueprint"),
    _template("person_death_date", "People", "Date", "when_person_died", "Q5", "human", "P570", "P570", "date of death", "On what month, day, and year did {descriptor} die?", answer_format="date", temporal_mode="date_answer", date_answer_granularity="day", query_tags=["staged_seed_query", "seed_window_daily", "seed_timeout_sensitive"], status="blueprint"),
    _template("film_release_date", "Arts and Media", "Date", "when_film_released", "Q11424", "film", "P577", "P577", "publication date", "On what month, day, and year was the film {descriptor} released?", answer_format="date", temporal_mode="date_answer", date_answer_granularity="day", status="blueprint"),
    ...
    _template("textbook_editor_count", "Education", "Number", "how_many_editors_textbook", "Q571", "textbook", "P577", "P98", "editor", "How many editors worked on the textbook {descriptor}?", answer_format="number", composition_style="fact_join", required_topic_keywords=["textbook", "education", "educational", "instructional", "curriculum", "course"], status="blueprint"),
    ...
    _template("ordinal_tournament_host_country", "Sports and Recreation", "Place", "which_country_hosted_ordinal_tournament", "Q132241", "tournament", "P585", "P17", "country", "Which country hosted the {ordinal} edition of {descriptor}?", composition_style="ordinal_fact", status="blueprint"),
