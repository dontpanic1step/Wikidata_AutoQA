...
BLUEPRINT_TEMPLATE_CATALOG = [
    ...
    _template("person_birth_date", "People", "Date", "when_person_born", "Q5", "human", "P569", "P569", "date of birth", "On what day, month, and year was {descriptor} born?", answer_format="date", temporal_mode="date_answer", date_answer_granularity="day", query_tags=["staged_seed_query", "seed_window_daily", "seed_timeout_sensitive"], status="blueprint"),
    _template("person_death_date", "People", "Date", "when_person_died", "Q5", "human", "P570", "P570", "date of death", "On what day, month, and year did {descriptor} die?", answer_format="date", temporal_mode="date_answer", date_answer_granularity="day", query_tags=["staged_seed_query", "seed_window_daily", "seed_timeout_sensitive"], status="blueprint"),
